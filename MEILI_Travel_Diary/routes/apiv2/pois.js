...
router.get("/insertTransportationPoi", function(req,res){
    ...
    {
        var sqlQuery = "select * from apiv2.insert_transition_poi($11,$2,$3,$4,$5,$6)";

        var prioryQuery = apiClient.query(sqlQuery,[name_,latitude,longitude,declaring_user_id,transportation_lines,transportation_types]);
...
router.get("/insertDestinationPoi", function(req,res){
    ...
    {
        var sqlQuery = "select * from apiv2.insert_destination_poi($1,$2,$3,$4)";

        var prioryQuery = apiClient.query(sqlQuery,[name_,latitude,longitude,declaring_user_id]);
